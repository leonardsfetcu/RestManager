namespace Manager
{
	partial class Kitchen
	{
		...
		private void InitializeComponent()
		{
			...
			this.dataGridView1.DataSource = this.kitchenViewBindingSource;
			...
			// 
			this.kitchenViewBindingSource.DataSource = typeof(Manager.KitchenView);
			// 
			// metroTile4
			// 
			...
			this.Name = "Kitchen";
			this.Text = "KitchenPanel";
			this.Load += new System.EventHandler(this.KitchenPanel_Load);
